...
1) Запустить контейнер указав ему имя и порты
2) Проверьте, что контейнер появился в списке контейнеров
3) Проверьте, скачен ли образ `httpd`
4) Попробуйте войти внутрь контейнера (после выйдете из него, написав команду `exit`)
5) Остановите и удалите ваш контейнер
